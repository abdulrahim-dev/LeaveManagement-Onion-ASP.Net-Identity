...
using LeaveManagement.Core.Domain.Login;
    ...
    public class AccountController : Controller
    {
       ...
       // [ValidateAntiForgeryToken]
        public async Task<ActionResult> Login(LoginModel model, string returnUrl)
        {
            ...
            var result = await _userManager.PasswordSignIn(model.UserName, model.Password, model.RememberMe, shouldLockout: false);
            switch (result)
            {
